...
| Read this | When |
|---|---|
| skill `context-curation` | When this file exceeds its budget, when docs contradict each other, when a milestone closes, or when 5+ sessions have passed since `docs/.curation-state.json` last_tuned |
```
